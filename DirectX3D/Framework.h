...
#define PATH_FIND PathFindManager::Get()
...
#define MAX_STICK_RANGE 32767.0f
#define STICK_DEADZONE 8000.0f

#define PAD_DOWN(k) XBoxPad::Get()->PadDown(k)
#define PAD_PRESS(k) XBoxPad::Get()->PadPress(k)
#define PAD_UP(k) XBoxPad::Get()->PadUp(k)
#define PAD_CONNECT XBoxPad::Get()->Connected()
#define PAD_LS XBoxPad::Get()->LS()
#define PAD_RS XBoxPad::Get()->RS()
...
#define TILE_HALFSIZE (TILE_SIZE * 0.5f)
#define WALL_TILE_CNT 10
#define WALL_HEIGHT (TILE_SIZE * WALL_TILE_CNT)

#define GRAVITY 1250.0f

#define DANTE_MOVE_SPEED 500.0f

#define CAM_MAX_ROT_X 88.6f
#define CAM_MIN_ROT_X 87.6f
#define CAM_ROT_SPEED 3.0f

#define MAX_UNIT_CNT 30
...
#include "Framework/Utilities/ThreadPool.h"
...
#include "Framework/Model/DissolveModelAnimatorInstancing.h"

using namespace GameMath;

#include "Framework/Utilities/XBoxPad.h"

#include "Framework/Environment/Camera.h"
#include "Framework/Environment/Environment.h"
#include "Framework/Environment/Shadow.h"

#include "Framework/Algorithm/JPSNode.h"
#include "Framework/Algorithm/JPSHeap.h"
#include "Framework/Algorithm/JPS.h"

#include "Manager/PathFindManager.h"
...
#include "Objects/Landscape/InstancingTile.h"

#include "Objects/Dungeon/Room.h"
#include "Objects/Dungeon/Hallway.h"
#include "Objects/Dungeon/Dungeon.h"

#include "Objects/Actor/Actor.h"
#include "Objects/Actor/Enemy.h"
#include "Objects/Actor/Empusa.h"
#include "Objects/Actor/Urizen.h"
#include "Objects/Actor/Dante.h"
